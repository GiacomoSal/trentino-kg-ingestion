...
OSM_ONTO_REPO: str
    id of the osm ontology repository that contains all the data, used to extract
    only the minimum subclass when creating the kg in the kg module
SCHEMA: str
    url of the schema.org ontology used inside the the default OSM ontology provided by Mayukh
INDIVIDUAL: str
    url for the base ontology that are the base url for the new individual creation, inside the default OSM ontology, provided by Mayukh
BASE: str
    base url used inside the default OSM ontology, provided by Mayukh
ROUTE: str
    base url for the route class inside the default OSM onotolgy, provided by Mayukh
...
mountain_path_profile: dict[str, float] = {
    "perimeter_refactor_ratio": 4,
    "a_on_b_ratio": 0.1,
}

city_path_profile: dict[str, float] = {
    "perimeter_refactor_ratio": 4.6,
    "a_on_b_ratio": 0.4,
}

RDF4J_SERVER: str = "http://192.168.178.33:7200"
OSM_ONTO_REPO: str = "Mio_Reference_KG"#"osm2kg"
SCHEMA:str = "http://schema.org/"
INDIVIDUAL:str ="http://www.co-ode.org/ontologies/ont.owl"
BASE:str = "http://www.semanticweb.org/lixiaoyue/ontologies/2023/2/untitled-ontology-26"
ROUTE:str = "http://www.co-ode.org/ontologies/ont.owl"
